...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "broker1" do |broker1|
      ...
      broker1.vm.network 'private_network', ip: '192.168.57.70'
  ...
  config.vm.define "broker2" do |broker2|
        ...
        broker2.vm.network 'private_network', ip: '192.168.57.71'
  ...
  config.vm.define "broker3" do |broker3|
          ...
          broker3.vm.network 'private_network', ip: '192.168.57.72'
    ...
    config.vm.define "broker4" do |broker4|
            ...
            broker4.vm.network 'private_network', ip: '192.168.57.73'
...
#               broker5.vm.network 'private_network', ip: '192.168.57.74'
#               broker5.vm.provider "virtualbox" do |v|
#                v.memory = 1024
#                v.cpus = 2
#               end
#       end
#     config.vm.define "broker6" do |broker6|
#             broker6.vm.box = "centos/7"
#             broker6.vm.network 'private_network', ip: '192.168.57.75'
#             broker6.vm.provider "virtualbox" do |v|
#              v.memory = 2048
#              v.cpus = 2
#             end
#     end
